...
<button id="0102" onclick="up()"style="background-color:green;width:300px;"><span style="font:25px;clolor:white;">Upvote</span></button>
<br>
<span>Current Price:
		<span id="15"></span>
...
<br>
<button id="0100"onclick="down()"style="background-color:red;width:300px; vertical-align: bottom;"><span style="font:25px;clolor:white;">Downvote</span></button>
</div>
<div>
