...
<body>
	...
	%>
		...
		<a href="votestock.jsp?id=<%=rs.getString("id") %>"  >
		<button style="float:right;margin-top:15px;margin-right:5px;background:#0769e0;"><span style="color:white;font:25px">Vote</span></button>
		</a>
		</div>
	<% }%>
